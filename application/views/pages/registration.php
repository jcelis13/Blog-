		...
		<form method="post" action="<?php echo site_url('user/registration');?>">
				...
				<div class="form-row">
					...
					<div class="form-group col-md-6">
						...
						<input type="text" class="form-control" placeholder="Lastname" name="lastname" size="20" value="<?php echo set_value('firstname');?>"   />
				 ...
				 <div class="form-group">
					   ...
					   <label style="color: red"><?php echo form_error('username'); ?></label>
					    <input type="text" class="form-control" name="username" placeholder="UserName" value="<?php echo set_value('firstname');?>" > 
			  	</div>
			  	<div class="form-row">
				  	<div class="form-group col-md-6">
				  		<label>Password</label>
				  		<label style="color: red"><?php echo form_error('password'); ?></label>
				  		<input type="password" class="form-control" placeholder="password" name="password" size="20" value="<?php echo set_value('firstname');?>" />

				  	</div>
				  	<div class="form-group col-md-6">
				  		<label>Confirm Password</label>
				  		<label style="color: red"><?php echo form_error('confirmpassword'); ?></label>
				  		<input type="password" class="form-control" placeholder="confirmpassword" name="confirmpassword" size="20" value="<?php echo set_value('firstname');?>" />				  		
				  	</div>
			  	</div>
